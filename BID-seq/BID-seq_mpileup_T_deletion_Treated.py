...
for line in sys.stdin:
    ...
    if counts >= 20:
        ...
        try:
            ...
            if total_counts_forward >= 20 and Deletion_counts_forward / total_counts_forward >= 0.05 and Deletion_counts_forward >= 4:
        ...
        try:
            ...
            if total_counts_Reverse >= 20 and Deletion_counts_reverse / total_counts_Reverse >= 0.05 and Deletion_counts_reverse >= 4:
